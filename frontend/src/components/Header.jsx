  ...
  return (
    <header className="border-b border-neutral-900 px-6 py-4 flex items-center justify-between bg-black sticky top-0 z-50">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          onClick={onLogout}
          className="text-[10px] font-mono tracking-widest text-neutral-500 hover:text-white uppercase transition-all flex items-center gap-1.5 border border-neutral-900 hover:border-neutral-800 px-2.5 py-1 rounded-lg animate-fadeIn"
          title={t.backToHome}
        >
